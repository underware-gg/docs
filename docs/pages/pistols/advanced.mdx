...
* Pistol at 1 pace: <Code>action_crit_chance = {constants.PISTOLS_KILL_AT_STEP_1}%</Code>
* Pistol at 10 paces: <Code>action_crit_chance = {constants.PISTOLS_KILL_AT_STEP_10}%</Code>
* Pistol chances between 1 and 10 paces are interpolated.
* Blades crit chance is constant: <Code>action_crit_chance = {constants.BLADES_CRIT}%</Code>
...
* 👑 Honourable: <Code>trickster_penalty = {constants.TRICKSTER_CRIT_PENALTY}%</Code> when the opponent is a Trickster.
* 🃏 Trickster: No penalty
* 👺 Villainous: <Code>trickster_penalty = {constants.TRICKSTER_CRIT_PENALTY}%</Code> when the opponent is a Trickster.
...
```rust
crit_chances = (action_crit_chance + crit_bonus + match_bonus - trickster_penalty)
crit_chances = max(crit_chances, action_crit_chance/2)
```
...
* Pistol at 1 pace: <Code>action_hit_chance = {constants.PISTOLS_HIT_AT_STEP_1}%</Code>
* Pistol at 10 paces: <Code>action_hit_chance = {constants.PISTOLS_HIT_AT_STEP_10}%</Code>
* Pistol chances between 1 and 10 paces are interpolated.
* Blades hit chance is constant: <Code>action_hit_chance = {constants.BLADES_HIT}%</Code>
...
* 👑 Honourable: <Code>trickster_penalty = {constants.TRICKSTER_HIT_PENALTY}%</Code> when the opponent is a Trickster.
* 🃏 Trickster: No penalty
* 👺 Villainous: <Code>trickster_penalty = {constants.TRICKSTER_HIT_PENALTY}%</Code> when the opponent is a Trickster.
...
```rust
hit_chances = (action_hit_chance + hit_bonus - trickster_penalty - injury_penalty)
hit_chances = max(hit_chances, action_hit_chance/2)
```
